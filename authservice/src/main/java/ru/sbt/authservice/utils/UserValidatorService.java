...
public class UserValidatorService implements UserValidator {
    ...
    public boolean validateLogin(String login) {
        ...
        if (!match.find()) {
            ...
            throw new AuthServiceException("Логин должен состоять из символов и цифр, начинаться с буквы и иметь длинну от 5 до 20 символов");
        }
        return true;
    }
    ...
    public boolean validatePassword(String password) {
        if (Objects.isNull(password)) {
            ...
            throw new AuthServiceException("поле пароля не может быть пустым");
        }
        ...
        if (!match.find()) {
            ...
            throw new AuthServiceException("Пароль должен состоять из символов и цифр и иметь размер от 6 до 15 символов");
